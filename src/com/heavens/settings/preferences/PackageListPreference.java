...
import com.heavens.support.preferences.PackageListAdapter;
import com.heavens.support.preferences.PackageListAdapter.PackageItem;
...
public class PackageListPreference extends PreferenceCategory implements
    ...
    public PackageListPreference(Context context, AttributeSet attrs) {
        ...
        boolean showSystemApps = customAttrs.getBoolean(R.styleable.PackageListPreferenceView_heavens_showSystemApps, true);
