package com.heavens.settings.preferences;
...
public class SeekBarPreferenceCham extends Preference implements SeekBar.OnSeekBarChangeListener {
    ...
    private static final String HEAVENSSETTINGSNS = "http://schemas.android.com/apk/res-auto";
    ...
    private void setValuesFromXml(AttributeSet attrs, Context context) {
        ...
        mUnitsLeft = getAttributeStringValue(attrs, HEAVENSSETTINGSNS, "unitsLeft", "");
        mUnitsRight = getAttributeStringValue(attrs, HEAVENSSETTINGSNS, "unitsRight", "");
        ...
        try {
            String newInterval = attrs.getAttributeValue(HEAVENSSETTINGSNS, "interval");
            if(newInterval != null)
